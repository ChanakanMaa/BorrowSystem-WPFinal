...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('borrow', '0003_auto_20200429_0342'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student_id', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='request_by', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Borrow_Item',
